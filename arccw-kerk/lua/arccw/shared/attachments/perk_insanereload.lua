...
att.Description = "Improves reloading and sight speed by 25% through improved weapon design and special training."
att.Desc_Pros = {
}
att.Desc_Cons = {
}
...
att.Mult_MeleeTime = 0.85

att.Mult_MeleeDamage = 0.75
